...
function WL(e, t) {
  ...
  switch (o.type) {
    ...
    case "template_literal":
      return !1;
    case "array":
      return WL(o.element, n);
    case "object": {
      for (let s in o.shape) if (WL(o.shape[s], n)) return !0;
      return !1;
    }
    case "union": {
      for (let s of o.options) if (WL(s, n)) return !0;
      return !1;
    }
    case "intersection":
      return WL(o.left, n) || WL(o.right, n);
    case "tuple": {
      for (let s of o.items) if (WL(s, n)) return !0;
      if (o.rest && WL(o.rest, n)) return !0;
      return !1;
    }
    case "record":
      return WL(o.keyType, n) || WL(o.valueType, n);
    case "map":
      return WL(o.keyType, n) || WL(o.valueType, n);
    case "set":
      return WL(o.valueType, n);
    case "promise":
    case "optional":
    case "nonoptional":
    case "nullable":
    case "readonly":
      return WL(o.innerType, n);
    case "lazy":
      return WL(o.getter(), n);
    case "default":
      return WL(o.innerType, n);
    case "prefault":
      return WL(o.innerType, n);
